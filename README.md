...
## Download openjdk:
**To install openjdk on your system:**
- ***<ins>Windows</ins>***: you can downloaded it [here](https://learn.microsoft.com/fr-fr/java/openjdk/install?tabs=exe%2Chomebrew%2Cubuntu), after install it.
...
- **First**, you must have: openjdk on your computer, to install it, look [here](#download-openjdk)
...
- **After**, to compile **java** program:
    ...
    *#example for [PENDU](https://github.com/Herra-dev/Pendu):*
        ...
        - execute: javac *.java -d directory/you/want/java/to/put/your/class/file (#this code compile all files with .java extension, generate classes files and put them into directory specified after **-d** option
- **Finally**, execute the output file:
    - go to: directory/where/you/have/put/your/class/file
...
## How to test Pendu:
- First, you must have [openjdk](#download-openjdk), after execute these command:
    - javac -cp lib/junit-platform-console-standalone-1.14.2.jar test/PenduTest.java src/com/pendu/Pendu.java src/com/pendu/enumeration/Player.java -d class/
    - java -jar lib/junit-platform-console-standalone-1.14.2.jar --class-path class/ --scan-class-path
